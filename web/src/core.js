...
export const config = {
  ...
  hlsDir: path.join(ROOT, 'public', 'hls'),
  ...
  segmentDuration: 2,
  hlsListSize: 10,
  sourcePlaylist: 'stream.m3u8',
  segmentPattern: 'seg%05d.ts',

  defaultDelay: 20,
  maxDelay: 300,
  ffmpegTimeout: 30000,
  ffmpegCheckInterval: 500,
  minSegmentsForStart: 3,

  defaultSlotDuration: 30,
  defaultOverlapDuration: 5,
...
export const state = {
  ...
  captions: [],
  currentMode: null,
  delaySec: config.defaultDelay,
  minSubtitlersRequired: config.minSubtitlers,
