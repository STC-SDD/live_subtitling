  ...
  try {
    ...
    if (el.sessionInfo) {
      el.sessionInfo.innerHTML = `
        <div style="background:rgba(155,89,182,0.05);border:1px solid rgba(155,89,182,0.2);border-radius:4px;padding:8px 12px;">
          <div style="font-size:0.75em;color:#888;">Session</div>
          <div style="font-size:0.85em;font-weight:500;color:#9b59b6;">${STC.escapeHtml(session.id)}</div>
        </div>
      `;
    }
  } catch (e) {
